...
import { tbDepartment, tbEmpAddress, tbEmployee, tbPosition, tbUser, tbEmpEmployment, tbEnum } from 'src/typeorm';
import { UsersController } from './controllers/users/users.controller';
import { UsersService } from './services/users/users.service';

@Module({
  imports: [TypeOrmModule.forFeature([tbUser, tbEmployee, tbEmpAddress, tbPosition, tbDepartment, tbEmpEmployment, tbEnum])],
